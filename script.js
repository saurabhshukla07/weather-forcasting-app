//Api details
        const weatherApi = {
            key : "bfafee62ba4b43629ca622db262e3170",
        ...
        function showweatherreport(weather){
            ...
            if (weathertype.textContent=='Clear'){
              ...
              document.body.style.backgroundImage="url('./Assets/weather.jpg')";
            }
        }
        ...
        var n = d.getHours();
        if (hrs.includes(n)){
          nicon.setAttribute("src",`./night.png`);
        }else{
          nicon.setAttribute("src","./day.png");
        }
